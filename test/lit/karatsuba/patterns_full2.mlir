builtin.module {
  ...
  ^bb165:
    ...
    ^bb174:
      %133 = pdl_interp.get_operand 1 of %129
      pdl_interp.is_not_null %133 : !pdl.value -> ^bb175, ^bb167
    ^bb175:
      %134 = pdl_interp.get_value_type of %131 : !pdl.type
      pdl_interp.are_equal %134, %5 : !pdl.type -> ^bb176, ^bb167
    ^bb176:
      %135 = pdl_interp.get_value_type of %132 : !pdl.type
      pdl_interp.are_equal %135, %5 : !pdl.type -> ^bb177, ^bb167
    ^bb177:
      %136 = pdl_interp.get_value_type of %133 : !pdl.type
    ...
    ^bb178:
      ...
      %139 = ematch.get_class_representative %133
  ...
  ^bb197:
    ...
    ^bb207:
      %163 = pdl_interp.get_operand 1 of %159
      pdl_interp.is_not_null %163 : !pdl.value -> ^bb208, ^bb199
    ^bb208:
      %164 = pdl_interp.get_value_type of %161 : !pdl.type
      pdl_interp.are_equal %164, %154 : !pdl.type -> ^bb209, ^bb199
    ^bb209:
      %165 = pdl_interp.get_value_type of %162 : !pdl.type
      pdl_interp.are_equal %165, %154 : !pdl.type -> ^bb210, ^bb199
    ^bb210:
      %166 = pdl_interp.get_value_type of %163 : !pdl.type
    ...
    ^bb211:
      ...
      %169 = ematch.get_class_representative %163
    ...
    ^bb217:
      %173 = pdl_interp.get_operand 1 of %159
      pdl_interp.is_not_null %173 : !pdl.value -> ^bb218, ^bb199
    ^bb218:
      %174 = pdl_interp.get_value_type of %171 : !pdl.type
      pdl_interp.are_equal %174, %154 : !pdl.type -> ^bb219, ^bb199
    ^bb219:
      %175 = pdl_interp.get_value_type of %172 : !pdl.type
      pdl_interp.are_equal %175, %154 : !pdl.type -> ^bb220, ^bb199
    ^bb220:
      %176 = pdl_interp.get_value_type of %173 : !pdl.type
    ...
    ^bb221:
      ...
      %179 = ematch.get_class_representative %173
  ...
  ^bb251:
    %208 = ematch.get_class_vals %204
    pdl_interp.foreach %209 : !pdl.value in %208 {
      %210 = pdl_interp.get_defining_op of %209 : !pdl.value {position = "root.operand[0].defining_op"}
      pdl_interp.is_not_null %210 : !pdl.operation -> ^bb252, ^bb253
    ^bb253:
      pdl_interp.continue
    ^bb252:
      pdl_interp.switch_operation_name of %210 to ["arith.muli", "arith.addi"](^bb254, ^bb255) -> ^bb253
    ^bb254:
      pdl_interp.check_operand_count of %210 is 2 -> ^bb256, ^bb253
    ^bb256:
      pdl_interp.check_result_count of %210 is 1 -> ^bb257, ^bb253
    ^bb257:
      %211 = pdl_interp.get_operand 0 of %210
      pdl_interp.is_not_null %211 : !pdl.value -> ^bb258, ^bb253
    ^bb258:
      %212 = pdl_interp.get_result 0 of %210
      pdl_interp.is_not_null %212 : !pdl.value -> ^bb259, ^bb253
    ^bb259:
      %213 = ematch.get_class_result %212
      pdl_interp.is_not_null %213 : !pdl.value -> ^bb260, ^bb253
    ^bb260:
      pdl_interp.are_equal %213, %204 : !pdl.value -> ^bb261, ^bb253
    ^bb261:
      %214 = pdl_interp.get_operand 1 of %210
      pdl_interp.is_not_null %214 : !pdl.value -> ^bb262, ^bb253
    ^bb262:
      %215 = pdl_interp.get_value_type of %211 : !pdl.type
      %216 = pdl_interp.get_value_type of %214 : !pdl.type
      pdl_interp.are_equal %215, %216 : !pdl.type -> ^bb263, ^bb253
    ^bb263:
      %217 = pdl_interp.get_value_type of %213 : !pdl.type
      pdl_interp.are_equal %215, %217 : !pdl.type -> ^bb264, ^bb253
    ^bb264:
      %218 = pdl_interp.get_value_type of %206 : !pdl.type
      pdl_interp.are_equal %215, %218 : !pdl.type -> ^bb265, ^bb253
    ^bb265:
      %219 = pdl_interp.get_value_type of %207 : !pdl.type
      pdl_interp.are_equal %215, %219 : !pdl.type -> ^bb266, ^bb253
    ^bb266:
      %220 = ematch.get_class_representative %214
      %221 = ematch.get_class_representative %207
      %222 = ematch.get_class_representative %211
      pdl_interp.record_match @rewriters::@ShiftMul1(%220, %221, %215, %222, %0 : !pdl.value, !pdl.value, !pdl.type, !pdl.value, !pdl.operation) : benefit(1), loc([]), root("arith.shli") -> ^bb253
    ^bb255:
      pdl_interp.check_operand_count of %210 is 2 -> ^bb267, ^bb253
    ^bb267:
      pdl_interp.check_result_count of %210 is 1 -> ^bb268, ^bb253
    ^bb268:
      %223 = pdl_interp.get_operand 0 of %210
      pdl_interp.is_not_null %223 : !pdl.value -> ^bb269, ^bb253
    ^bb269:
      %224 = pdl_interp.get_result 0 of %210
      pdl_interp.is_not_null %224 : !pdl.value -> ^bb270, ^bb253
    ^bb270:
      %225 = ematch.get_class_result %224
      pdl_interp.is_not_null %225 : !pdl.value -> ^bb271, ^bb253
    ^bb271:
      pdl_interp.are_equal %225, %204 : !pdl.value -> ^bb272, ^bb253
    ^bb272:
      %226 = pdl_interp.get_operand 1 of %210
      pdl_interp.is_not_null %226 : !pdl.value -> ^bb273, ^bb253
    ^bb273:
      %227 = pdl_interp.get_value_type of %223 : !pdl.type
      %228 = pdl_interp.get_value_type of %226 : !pdl.type
      pdl_interp.are_equal %227, %228 : !pdl.type -> ^bb274, ^bb253
    ^bb274:
      %229 = pdl_interp.get_value_type of %225 : !pdl.type
      pdl_interp.are_equal %227, %229 : !pdl.type -> ^bb275, ^bb253
    ^bb275:
      %230 = pdl_interp.get_value_type of %206 : !pdl.type
      pdl_interp.are_equal %227, %230 : !pdl.type -> ^bb276, ^bb253
    ^bb276:
      %231 = pdl_interp.get_value_type of %207 : !pdl.type
      pdl_interp.are_equal %227, %231 : !pdl.type -> ^bb277, ^bb253
    ^bb277:
      %232 = ematch.get_class_representative %223
      %233 = ematch.get_class_representative %207
      %234 = ematch.get_class_representative %226
      pdl_interp.record_match @rewriters::@ShiftAdd(%232, %233, %227, %234, %0 : !pdl.value, !pdl.value, !pdl.type, !pdl.value, !pdl.operation) : benefit(1), loc([]), root("arith.shli") -> ^bb253
    } -> ^bb5
  ^bb4:
    pdl_interp.check_operand_count of %0 is 1 -> ^bb278, ^bb5
  ^bb278:
    pdl_interp.check_result_count of %0 is 1 -> ^bb279, ^bb5
  ^bb279:
    %235 = pdl_interp.get_operand 0 of %0
    pdl_interp.is_not_null %235 : !pdl.value -> ^bb280, ^bb5
  ^bb280:
    %236 = pdl_interp.get_result 0 of %0
    pdl_interp.is_not_null %236 : !pdl.value -> ^bb281, ^bb5
  ^bb281:
    %237 = ematch.get_class_result %236
    pdl_interp.is_not_null %237 : !pdl.value -> ^bb282, ^bb5
  ^bb282:
    %238 = ematch.get_class_vals %235
    pdl_interp.foreach %239 : !pdl.value in %238 {
      %240 = pdl_interp.get_defining_op of %239 : !pdl.value {position = "root.operand[0].defining_op"}
      pdl_interp.is_not_null %240 : !pdl.operation -> ^bb283, ^bb284
    ^bb284:
      pdl_interp.continue
    ^bb283:
      pdl_interp.switch_operation_name of %240 to ["arith.extui", "arith.addi"](^bb285, ^bb286) -> ^bb284
    ^bb285:
      pdl_interp.check_operand_count of %240 is 1 -> ^bb287, ^bb284
    ^bb287:
      pdl_interp.check_result_count of %240 is 1 -> ^bb288, ^bb284
    ^bb288:
      %241 = pdl_interp.get_operand 0 of %240
      pdl_interp.is_not_null %241 : !pdl.value -> ^bb289, ^bb284
    ^bb289:
      %242 = pdl_interp.get_result 0 of %240
      pdl_interp.is_not_null %242 : !pdl.value -> ^bb290, ^bb284
    ^bb290:
      %243 = ematch.get_class_result %242
      pdl_interp.is_not_null %243 : !pdl.value -> ^bb291, ^bb284
    ^bb291:
      pdl_interp.are_equal %243, %235 : !pdl.value -> ^bb292, ^bb284
    ^bb292:
      %244 = pdl_interp.get_value_type of %237 : !pdl.type
      %245 = ematch.get_class_representative %241
      pdl_interp.record_match @rewriters::@ZextCompose(%245, %244, %0 : !pdl.value, !pdl.type, !pdl.operation) : benefit(3), loc([]), root("arith.extui") -> ^bb284
    ^bb286:
      pdl_interp.check_operand_count of %240 is 2 -> ^bb293, ^bb284
    ^bb293:
      pdl_interp.check_result_count of %240 is 1 -> ^bb294, ^bb284
    ^bb294:
      %246 = pdl_interp.get_operand 0 of %240
      pdl_interp.is_not_null %246 : !pdl.value -> ^bb295, ^bb284
    ^bb295:
      %247 = pdl_interp.get_result 0 of %240
      pdl_interp.is_not_null %247 : !pdl.value -> ^bb296, ^bb284
    ^bb296:
      %248 = ematch.get_class_result %247
      pdl_interp.is_not_null %248 : !pdl.value -> ^bb297, ^bb284
    ^bb297:
      pdl_interp.are_equal %248, %235 : !pdl.value -> ^bb298, ^bb284
    ^bb298:
      %249 = pdl_interp.get_operand 1 of %240
      pdl_interp.is_not_null %249 : !pdl.value -> ^bb299, ^bb284
    ^bb299:
      %250 = ematch.get_class_vals %249
      pdl_interp.foreach %251 : !pdl.value in %250 {
        %252 = pdl_interp.get_defining_op of %251 : !pdl.value {position = "root.operand[0].defining_op.operand[1].defining_op"}
        pdl_interp.is_not_null %252 : !pdl.operation -> ^bb300, ^bb301
      ^bb301:
        pdl_interp.continue
      ^bb300:
        pdl_interp.check_operation_name of %252 is "arith.extui" -> ^bb302, ^bb301
      ^bb302:
        pdl_interp.check_operand_count of %252 is 1 -> ^bb303, ^bb301
      ^bb303:
        pdl_interp.check_result_count of %252 is 1 -> ^bb304, ^bb301
      ^bb304:
        %253 = pdl_interp.get_result 0 of %252
        pdl_interp.is_not_null %253 : !pdl.value -> ^bb305, ^bb301
      ^bb305:
        %254 = ematch.get_class_result %253
        pdl_interp.is_not_null %254 : !pdl.value -> ^bb306, ^bb301
      ^bb306:
        pdl_interp.are_equal %254, %249 : !pdl.value -> ^bb307, ^bb301
      ^bb307:
        %255 = pdl_interp.get_operand 0 of %252
        pdl_interp.is_not_null %255 : !pdl.value -> ^bb308, ^bb301
      ^bb308:
        %256 = ematch.get_class_vals %246
        pdl_interp.foreach %257 : !pdl.value in %256 {
          %258 = pdl_interp.get_defining_op of %257 : !pdl.value {position = "root.operand[0].defining_op.operand[0].defining_op"}
          pdl_interp.is_not_null %258 : !pdl.operation -> ^bb309, ^bb310
        ^bb310:
          pdl_interp.continue
        ^bb309:
          pdl_interp.check_operation_name of %258 is "arith.extui" -> ^bb311, ^bb310
        ^bb311:
          pdl_interp.check_operand_count of %258 is 1 -> ^bb312, ^bb310
        ^bb312:
          pdl_interp.check_result_count of %258 is 1 -> ^bb313, ^bb310
        ^bb313:
          %259 = pdl_interp.get_operand 0 of %258
          pdl_interp.is_not_null %259 : !pdl.value -> ^bb314, ^bb310
        ^bb314:
          %260 = pdl_interp.get_result 0 of %258
          pdl_interp.is_not_null %260 : !pdl.value -> ^bb315, ^bb310
        ^bb315:
          %261 = ematch.get_class_result %260
          pdl_interp.is_not_null %261 : !pdl.value -> ^bb316, ^bb310
        ^bb316:
          pdl_interp.are_equal %261, %246 : !pdl.value -> ^bb317, ^bb310
        ^bb317:
          %262 = pdl_interp.get_value_type of %261 : !pdl.type
          %263 = pdl_interp.get_value_type of %254 : !pdl.type
          pdl_interp.are_equal %262, %263 : !pdl.type -> ^bb318, ^bb310
        ^bb318:
          %264 = pdl_interp.get_value_type of %248 : !pdl.type
          pdl_interp.are_equal %262, %264 : !pdl.type -> ^bb319, ^bb310
        ^bb319:
          %265 = pdl_interp.get_value_type of %237 : !pdl.type
          %266 = ematch.get_class_representative %246
          %267 = ematch.get_class_representative %249
          pdl_interp.record_match @rewriters::@ZextAdd(%266, %265, %267, %0 : !pdl.value, !pdl.type, !pdl.value, !pdl.operation) : benefit(3), loc([]), root("arith.extui") -> ^bb310
        } -> ^bb301
      } -> ^bb284
    } -> ^bb5
  }
